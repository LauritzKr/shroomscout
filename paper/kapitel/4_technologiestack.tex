...
Uvicorn ist ein leichtgewichtiger, hochperformanter Application Server Gateway Interface (ASGI) Server, implementiert in Python. 
ASGI ist ein Spezifikationsstandard, der als Schnittstelle zwischen asynchronen Python Web-Apps und Servern dient, ähnlich wie das Web Server Gateway Interface (WSGI) für synchrone Python Web-Apps. 
Uvicorn nutzt die asynchrone und ereignisgesteuerte Programmierung, die in Python 3.5+ durch die Einführung von asyncio standardisiert wurde, 
um eine effiziente und skalierbare Grundlage für das Hosting von Webanwendungen und -diensten zu bieten.
